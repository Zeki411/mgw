...
{
	mac_msg->BufSize = 255;
	mac_msg->MHDR.Bits.MType = FRAME_TYPE_DATA_UNCONFIRMED;
	mac_msg->FHDR.FCtrl.Bits.Ack = 1;
	mac_msg->FHDR.FLen = 0;
	memset(mac_msg->FRMPayload,0,mac_msg->FRMPayloadSize);
	mac_msg->FRMPayloadSize = 0;
}
